# ShopEase Agentic AI — Final Presentation Outline (Person 5)

This is the slide-by-slide narrative for the final demo. Person 5 owns
...
|---|-------|---------|------------------|
| 1 | Title + team | Person 1 | ShopEase Agentic AI · 5-person team · roles |
| 2 | Business problem | Person 1 | Fragmented context, slow resolution, churn |
| 3 | Why agents (vs single LLM) | Person 1 | Modularity, safety, explainability |
| 4 | High-level architecture | Person 1 | Mermaid diagram from README |
| 5 | Agent collaboration flow | Person 1 | Sequence diagram for one scenario |
| 6 | Knowledge grounding | Person 2 | Policy KB structure + retrieval |
| 7 | Policy retrieval demo | Person 2 | Live RAG on coupon issue |
| 8 | Mock integrations | Person 3 | Order/Payment/Logistics APIs |
| 9 | Workflow automation demo | Person 3 | Return initiated end-to-end |
| 10 | Customer chat UI | Person 4 | Live chat window |
| 11 | Agent assist console | Person 4 | Right-pane: intent, sentiment, policy, risk |
| 12 | Product Advisory feature | Person 4 | Compare-two-products with use case |
| **13** | **Escalation & risk model** | **Person 5** | **6-factor weighted matrix + 3 bands** |
| **14** | **Human-in-the-loop** | **Person 5** | **Approval queue + audit + override** |
| **15** | **Evaluation methodology** | **Person 5** | **25 cases + 70 perturbations + metrics** |
| **16** | **Live metrics** | **Person 5** | **Pass rate · precision · recall · latency** |
| **17** | **Business impact** | **Person 5** | **Hours saved / week, deflection %** |
| **18** | **Responsible AI** | **Person 5** | **Audit log, SLA, override path** |
| **19** | **Limitations** | **Person 5** | **Mock data, single language, no live integrations** |
| **20** | **Roadmap + Q&A** | **Person 5** | **Production migration table from README** |

---

## Person 5 slide details
...
Pull these tables directly from [tests/evaluation/report_v1.md](../tests/evaluation/report_v1.md) (pre-Person-3 baseline). After Person 3 lands, regenerate as `report_v2.md` and show **both** side by side.
...
|------|------|--------------|
| 0:00 | Open agent console | Person 4's right-pane view |
...
- [ ] Slides 13-20 reviewed by Person 1 for narrative consistency
